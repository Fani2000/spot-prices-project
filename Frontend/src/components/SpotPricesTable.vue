<template>
  <DataTable :value="data" tableStyle="min-width: 50rem" stripedRows paginator :rows="5" :rowsPerPageOptions="[5, 10, 20, 50]" size="large">
    ...
    <Column field="move" sortable header="Move"></Column>
    <Column field="pmove" sortable header="Percentage Move"></Column>
    <Column field="datetime" sortable header="Time"></Column>
  </DataTable>
</template>
